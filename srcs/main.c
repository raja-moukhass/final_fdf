...
/*   Updated: 2020/01/09 16:00:45 by ramoukha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	*start = (t_point){env->zoom * x, env->zoom * y, env->store.tab[y][x]};
